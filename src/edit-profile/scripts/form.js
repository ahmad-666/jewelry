import data from './basket.js' ;
//form validation------------------------------
//form validation------------------------------
//form validation------------------------------
let addressSubmit = data.addressSlide.querySelector('.row button.next') ;
function FormValidate(form){
    this.form = form ;
    this.inputs = this.form.querySelectorAll('.validate') ;
    this.validate = false ;
    addressSubmit.addEventListener('click',this.formSubmit.bind(this)) ;
}
...
let addressValidate =  new FormValidate(data.basketForm) ;
//select/option------------------------------------------
//select/option------------------------------------------
//select/option------------------------------------------
